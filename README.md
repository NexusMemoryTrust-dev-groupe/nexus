...
[![Version](https://img.shields.io/badge/version-1.0.2-2ea043?style=for-the-badge)](https://github.com/NexusMemoryTrust-dev-groupe/nexus/releases)
...
[![Tests](https://img.shields.io/badge/tests-513%20passing-2ea043?style=for-the-badge)](#качество-и-тестирование)
[![License](https://img.shields.io/badge/license-PROPRIETARY-d73a49?style=for-the-badge)](LICENSE)
[![MCP](https://img.shields.io/badge/MCP-74%20tools-a855f7?style=for-the-badge)](#mcp-сервер--подключение-любого-ии)
...
**74 инструмента** доступны любому ИИ через Model Context Protocol. Автоматическая регистрация в один клик — не нужно вручную править JSON-конфиги.
...
- 74 инструмента для работы с графом и файлами
...
Nexus работает как **MCP-сервер** (Model Context Protocol) и отдаёт **74 инструмента** любому совместимому ИИ.
...
│  MCP-сервер: 74 инструмента через stdio                 │
└────────────────────────┬─────────────────────────────────┘
                         │
┌────────────────────────┴─────────────────────────────────┐
